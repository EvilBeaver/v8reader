...
#define V8UNPACK_NOT_V8_FILE_1 (V8UNPACK_NOT_V8_FILE-1)
#define V8UNPACK_NOT_V8_FILE_2 (V8UNPACK_NOT_V8_FILE-2)
#define V8UNPACK_HEADER_ELEM_NOT_CORRECT (V8UNPACK_ERROR-5)
...
public:
	...
	bool IsV8File(BYTE *pFileData, ULONG FileDataSize, ULONG *dwReason = NULL);
